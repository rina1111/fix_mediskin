...
<div class="card">
  ...
  <p class="title"style=" font-size: 14px;font-family: times rowman;"> Nama :<a href=""style=" font-size: 14px; margin-right: 4px;font-family: times rowman;"> &nbsp<?php echo ($pecah['nama_pasien']);?></a></p>
 <p class="title"style=" font-size: 14px;font-family: times rowman;"> Klinik :<a href=""style=" font-size: 14px;font-family: times rowman;"> &nbsp<?php echo ($pecah['klinik_pilih']);?></a></p>
 <p class="title"style=" font-size: 14px;font-family: times rowman;"> Dokter :<a href=""style=" font-size: 14px;font-family: times rowman;"> &nbsp<?php echo ($pecah['dokter_pilih']);?></a></p>
 <p class="title"style=" font-size: 14px;font-family: times rowman;"> Tanggal Appointment:<a href=""style=" font-size: 14px;font-family: times rowman;"> &nbsp <?php echo ($pecah['tgl']);?></a></p>
  <p class="title"style=" font-size: 14px;font-family: times rowman;"> Hari & Waktu:<a href=""style=" font-size: 14px;font-family: times rowman;"> &nbsp<?php echo ($pecah['jadwal']);?></a></p>
