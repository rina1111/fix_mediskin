				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Data Dokter</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Data <span class="text-bold">Dokter</span></h5>
...
?>
											...
											<tr>
												...
												<td class="hidden-xs"><?php echo $row['id_dokter'];?></td>
												<td><?php echo $row['nama_dokter'];?></td>
												<td><?php echo $row['ruangan'];?>
												</td>
												<td><?php echo $row['alamat_dokter'];?></td>
                                                <td><?php echo $row['klinik_dokter'];?></td>
												<td><?php echo $row['jadwal_dokter'];?></td>
												<td><img src="../img_db/"<?php echo $row['gambar'];?> width="100"></td>
												</td>
												<td >
