  ...
  $result = mysqli_query($koneksi, $query); ?>
				...
				<div class="col-lg-6 intro_col">
					<div class="intro_form_container">
						...
						<form action="#" class="intro_form" id="intro_form" method="post" enctype="multipart/form-data">
							<div class="d-flex flex-row align-items-start justify-content-between flex-wrap">
								<input type="text" name="nama" class="intro_input" placeholder="Nama Lengkap" required="required">
								<input type="text" name="email" class="intro_input" placeholder="E-mail" required="required">
								<input type="text" name="telepon" class="intro_input" placeholder="Telepon" required="required">
								<select class="intro_select intro_input" required="required" name="klinik">
									<option disabled="" selected="" value="">Klinik Kecantikan</option>

									<option value="Erha Klinik">Erha Klinik</option>
									<option value="Natasha Klinik">Natasha Klinik</option>
									<option value="Airin Klinik">Airin Klinik</option>
									<option value="Carissa Klinik">Carissa Klinik</option>
									<option value="MD Glowing Klinik">MD Glowing Klinik</option>
									
								</select>

								<select class="intro_select intro_input" required="required" name="dokter">  
								...
								<select class="intro_select intro_input" required="required" name="jadwal">
										<option disabled="" selected="" value="">Jadwal Dokter</option>

										<option value="Senin : 10.00 s/d 14.30 ">Senin : 10.00 s/d 14.30 </option>
										<option value="Rabu : 10.00 s/d 14.30 ">Rabu : 10.00 s/d 14.30</option>
										<option value="Senin : 09.00 s/d 11.00 ">Senin : 09.00 s/d 11.00</option>
										<option value="Rabu : 10.00 s/d 13.00 ">Rabu : 10.00 s/d 13.00</option>
										<option value="Kamis : 14.00 s/d 18.00 ">Kamis : 14.00 s/d 18.00</option>
										<option value="Jumat : 14.00 s/d 18.00 ">Jumat : 14.00 s/d 18.00</option>
...
// query SQL untuk insert data
		...
		$koneksi->query("INSERT INTO apoointment(nama_pasien,email,telepon,klinik_pilih,dokter_pilih,jadwal,tgl)VALUES ('$_POST[nama]','$_POST[email]','$_POST[telepon]','$_POST[klinik]','$_POST[dokter]','$_POST[jadwal]', '$_POST[tgl]')");
		
echo "<script>alert('Terimakasih'); </script>";
echo "<meta http-equiv='refresh' content='1;url=table_appo.php?halaman=produk'>";
}
